...
from htm_pytorch import HTMAttention, HTMBlock, HTMBlockReLU, HTMBlockNoLN, HTMBlockReLUNoLN
...
class HTMTransformerBlockNoLN(Module):
    def __init__(self, embed_dim, num_heads, config):
        ...
        """
        super(HTMTransformerBlockNoLN, self).__init__()
        ...
        # HTM Block
        if self.imr:
            self.htmblock = HTMBlockReLUNoLN(
                dim = embed_dim,
    ...
    def forward(self, value, key, query, mask):
        ...
        if self.input_attention:
            ...
            # Add skip connection (we remove normalization here)
            if self.imr:
...
class HTMTransformerNoLN(nn.Module):
    ...
    def __init__(self, config, input_dim, max_episode_steps) -> None:
        ...
        self.transformer_blocks = nn.ModuleList([
            HTMTransformerBlockNoLN(self.embed_dim, self.num_heads, config) 
