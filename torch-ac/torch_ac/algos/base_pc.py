...
class BaseAlgoPC(ABC):
    ...
    def __init__(self, envs, acmodels, device, num_frames_per_proc, discount, lr, gae_lambda, entropy_coef,
        ...
        # First model in cascade
        self.acmodel = acmodels[0]
        self.device = device
    ...
    def collect_experiences_cascade(self):
        ...
        for i in reversed(range(self.num_frames_per_proc)):
            ...
            next_value = self.values_cascade[0][i+1] if i < self.num_frames_per_proc - 1 else next_value
            next_advantage = self.advantages[i+1] if i < self.num_frames_per_proc - 1 else 0

            delta = self.rewards[i] + self.discount * next_value * next_mask - self.values_cascade[0][i]
    ...
    def collect_experiences(self):
        ...
        # add cumulative log_probs
        exps.cumlog_prob = torch.cumsum(exps.log_prob, dim=0)
